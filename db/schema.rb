...
ActiveRecord::Schema[7.0].define(version: 2023_07_31_160232) do
  ...
  create_table "transaction_categories", force: :cascade do |t|
    ...
    t.index ["transaction_entry_id"], name: "index_transaction_categories_on_transaction_entry_id"
  end
  ...
  add_foreign_key "transaction_categories", "transaction_entries"
